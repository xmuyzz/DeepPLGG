...
def parse_opts():
    ...
    # train model
    parser.add_argument('--task', default='tumor', type=str, help='BRAF_status|BRAF_fusion|tumor')
    ...
    parser.add_argument('--cnn_model', default='MobileNetV2', type=str, help='cnn model')
    ...
    parser.add_argument('--n_bootstrap', default=100, type=int, help='n times of bootstrap to calcualte 95% CI')
    parser.add_argument('--saved_model', default='09-0.76.h5', type=str, help='saved model name')    
    parser.add_argument('--_load_model', default='load_weights', type=str, help='load_model|load_weights')
    
    # fine tune model
    parser.add_argument('--trained_weights', default='MobileNetV2_final.h5', type=str, help='weights fine tuning')
    ...
    parser.add_argument('--fine_tune_model', action='store_true', help='If true, training is performed.')
    parser.set_defaults(transfer_learning=True)
